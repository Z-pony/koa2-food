module.exports = {
    ...
    "padding-line-between-statements": [2, {
        "blankLine": "always",
        "prev": "*", 
        "next": ["function", "block", "block-like", "cjs-export", "try", "throw", "return", "switch"]
    }], //要求在块周围有空行
    ...
    "brace-style": [2, "stroustrup"],//大括号风格
    ...
    "padded-blocks": [0, { "blocks": "never" }],//块语句内行首行尾是否要空行
    ...
    "sort-vars": 2,//变量声明时排序
    "space-before-blocks": [2, "never"],//不以新行开始的块{前面要不要有空格
